...
import arc.util.Tmp;
import Code.SUtils;
import Code.ui.fragments.sidebar.windows.UnitWindow;
...
public class SBar extends Element {
    ...
    private static final Drawable
            barSprite = SUtils.getDrawable(Core.atlas.find("Code-barS"), 10, 10, 9, 9),
            barTopSprite = SUtils.getDrawable(Core.atlas.find("Code-barS-top"), 10, 10, 9, 9);
