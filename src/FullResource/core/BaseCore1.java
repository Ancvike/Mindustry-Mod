...
public class BaseCore1 extends Table {
...
//    public BaseCore1(String name){
//        this(new TextureRegionDrawable(Core.atlas.find("clear")), name, null);
//    }
    public BaseCore1(TextureRegionDrawable icon, String name){
        this(icon, name, null);
    }
    public BaseCore1(TextureRegionDrawable icon, String name, @Nullable Cons<Table> content) {
        this.icon = icon;
        this.name = name;
    ...
    private static class DragHandleListener extends TouchPosInputListener {
        final BaseCore1 targetWindow;
        public DragHandleListener(BaseCore1 targetWindow) {
    ...
    private static class ScaleInputListener extends TouchPosInputListener {
        final BaseCore1 targetWindow;
        public ScaleInputListener(BaseCore1 targetWindow) {
            this.targetWindow = targetWindow;
        }
        ...
        public void touchDragged(InputEvent event, float dx, float dy, int pointer) {
            ...
            if(targetWindow.getWidth() + w < targetWindow.minWindowWidth || targetWindow.getWidth() + w > BaseCore1.maxWindowWidth) w = 0;
            if(targetWindow.getHeight() - h < targetWindow.minWindowHeight || targetWindow.getHeight() - h > BaseCore1.maxWindowHeight) h = 0;
